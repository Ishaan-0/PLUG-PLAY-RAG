...
total_docs = sum(col["total_docs"] for col in db_stats["collections"].values())
st.metric("Total Documents", total_docs)
total_chunks = sum(col["total_chunks"] for col in db_stats["collections"].values())
